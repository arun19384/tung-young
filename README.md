...
- เลือกเส้นทางค่าโดยสารรวมถูกที่สุดจากเส้นทาง BTS/MRT ที่รองรับ หากราคาเท่ากันเลือกต่อสายน้อยที่สุด แล้วเลือกจำนวนสถานีน้อยที่สุด
- แสดงเวลาโดยประมาณ ค่าโดยสารบุคคลทั่วไปเที่ยวเดียวแบบราคาจริงจาก BTS/BEM และคำแนะนำจุดต่อสายก่อนเริ่มเดินทาง
- แสดงแผนที่เส้นทางย่อแบบออฟไลน์ พร้อมสีสาย จุดเริ่ม ปลายทาง และจุดต่อสาย
